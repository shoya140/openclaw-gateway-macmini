...
"agents": {
  ...
  "list": [
    ...
    { "id": "personal-agent", "model": "lmstudio/unsloth/Qwen3.6-35B-A3B-UD-MLX-4bit", "workspace": "/Users/claw/.openclaw/workspace" }
  ]
}
```
